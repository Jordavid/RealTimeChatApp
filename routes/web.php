...
Route::post('/notification/getNotification', 'NotificationController@getNotification')->name('notifications');
Route::post('/notification/markAsRead', 'NotificationController@maskAsRead')->name('maskNotificationAsRead');
Auth::routes();
